...
const FraudDetection = () => {
    return (
        <div className="features_section_c grid grid-cols-2  justify-between  max-[1240px]:flex-col min-[1240px]:items-end gap-20 ">
            ...
            <div className="right-section flex-1 space-y-20 max-w-125 ">
                ...
                <div className="bottom space-y-4.75 ">
                    <h3 className=" text-h-4 min-[580px]:text-h-3 leading-8  min-[580px]:leading-11 font-bold">
