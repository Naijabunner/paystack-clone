...
const NAV_ITEMS: (
    ...
    | ({ type: 'large' } & LargeNavigationItemProps)
)[] = [
        {
            ...
            features: [
                {
                    imageUrl: 'https://paystack.com/assets/img/icon/navigation/learn/blog_db.svg',
                    title: 'Why Choose Paystack',
                    description: "Over 200,000 businesses trust Paystack. Here's why"
                },
                {
                    imageUrl: 'https://paystack.com/assets/img/icon/navigation/why_paystack/success_rates_db.svg',
                    title: 'Success Rates',
                    description: "Optimized transaction routes for the best success rates" // Demo data
                },
                {
                    imageUrl: 'https://paystack.com/assets/img/icon/navigation/why_paystack/why_choose_paystack_db.svg',
                    title: 'Demo',
                    description: "See how Paystack works in real-time" // Demo data
                }
            ],
            categories: [
                {
                    title: 'Your Growth Stage',
                    items: ['For Enterprises', 'For Corporates', 'For Global Brands', 'For Startups']
                },
                {
                    title: 'Your Business Type',
                    items: ['For Fintechs', 'For Agencies', 'For Schools', 'For Betting']
                }
            ]
        },
        {
        ...
        },
       {
            ...
            features: [
                ...
                {
                    imageUrl: 'https://paystack.com/assets/img/icon/navigation/learn/guides_db.svg',
                    title: 'Guides',
                    description: "Big ideas in payments, explained in simple English"
                },
                {
                    imageUrl: 'https://paystack.com/assets/img/icon/navigation/learn/tutorials_db.svg',
                    title: 'Video Tutorials',
                    description: "Quick video tutorials on how to use Paystack"
                },
                {
                    imageUrl: 'https://paystack.com/assets/img/icon/navigation/learn/decode_fintech_db.svg',
            ...
            categories: [
                {
                    title: 'Company',
                    items: ['About Us', 'Changelog', 'Subscribe', 'Compliance', 'Careers', 'Brand', 'Media Kit']
                },
            ]
        },
    ]
        ...
        <div className="flex items-center gap-5">
            ...
            <ul className="flex items-center gap-5">
                {NAV_ITEMS.map((item, index) => {
                    if (item.type === 'small') {
                        return <SmallNavigationItem key={index} title={item.title} links={item.links} />
                    } else {
                        return (
                            <LargeNavigationItem
                                key={index}
